...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/bookASpecificApartment/**").authenticated()

                .antMatchers("/booking/**").hasAuthority("USER_CUSTOMER")
                .antMatchers("/newBookingCreate/**").hasAuthority("USER_CUSTOMER")
                .antMatchers("/getBooking/**").hasAuthority("USER_CUSTOMER")
                .antMatchers("/deleteBookingForm/**").hasAuthority("USER_CUSTOMER")
                .antMatchers("/bookASpecificApartment/**").hasAuthority("USER_CUSTOMER")
